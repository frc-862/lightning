...
public class FollowTrajectory extends CommandBase {
	...
	/**
	 * Constructs a new FollowTrajectory that, when executed, will follow the
	 ...
	 *                        drive.
	 * @param leftController  The PIDFController for the left side of the robot
	 *                        drive.
	 * @param rightController The PIDFController for the right side of the robot
	 *                        drive.
	...
	public FollowTrajectory(
		...
		m_trajectory = requireNonNullParam(trajectory, "trajectory", "FollowTrajectory");
		m_pose = requireNonNullParam(pose, "pose", "FollowTrajectory");
		m_follower = requireNonNullParam(controller, "controller", "FollowTrajectory");
		m_feedforward = feedforward;
		m_kinematics = requireNonNullParam(kinematics, "kinematics", "FollowTrajectory");
		m_speeds = requireNonNullParam(wheelSpeeds, "wheelSpeeds", "FollowTrajectory");
		m_leftController = requireNonNullParam(leftController, "leftController", "FollowTrajectory");
		m_rightController = requireNonNullParam(rightController, "rightController", "FollowTrajectory");
		m_output = requireNonNullParam(outputVolts, "outputVolts", "FollowTrajectory");
	...
	public void initialize() {
		...
		m_prevSpeeds = (DifferentialDrivetrainState) m_kinematics.inverse(new DrivetrainSpeed(
	...
	public void execute() {
		...
		var targetWheelSpeeds = m_kinematics.inverse(
