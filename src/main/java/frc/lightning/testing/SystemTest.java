 ...
 * {@link frc.lightning.testing.SystemTestCommand SystemTestCommand} which is configured to run
...
public abstract class SystemTest extends CommandBase implements Comparable<SystemTest> {
     ...
     * {@link frc.lightning.LightningRobot LightningRobot} is
     ...
     * @param code {@link frc.lightning.fault.FaultCode.Codes FaultCode} relating
     * to the SystemTest
     */
    ...
    /**
     * The relating {@link frc.lightning.fault.FaultCode.Codes FaultCode} 
